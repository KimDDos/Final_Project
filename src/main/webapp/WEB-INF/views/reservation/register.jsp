...
<![endif]-->
			...
			<div id="content">
				...
				<form method="post" name="frm" id="frm" action="/reservation/register">
					<sec:authentication property="principal.mdto.mvo.userSerialNo" var="userSerialNo" />
					<input class="form-control" id="userSerialNo" name="userSerialNo" type="hidden"
						value="${userSerialNo}" />
					...
					<div class="programCon" style="margin-top: 0; padding-top: 5px;">
								...
								<tbody>
									<tr>
										<th style="background: #fff;"><span class="col01"></span>헬스장
											이름</th>
										<td><input name="rvTitle" type="text" readonly="readonly" id="clinic_fk"
												value="${ppTitle}" class="inputTxt inputName wh420"
												style="color: silver;">
										</td>
									</tr>
									<tr>
										<th style="background: #fff;"><span class="col01"></span>헬스장
											주소</th>
										<td><input name="rvAddress" type="text" readonly="readonly" id="clinic_fk"
												value="${ppAddress}" style="color: silver;"
							...
							<table>
								...
								<tbody>
									<tr style="border-bottom: none;">
										...
										<td><select name="ppTitle" id="clinic_fk" data-value="운동목적을 선택해주세요."
												class="chg_sec">
								...
								<div class="schedule">
									<div class="calender_wrap">
										<table id="calendar" style="width: 100%;">
											...
											<thead>
												<tr>
													<th><a name="preMon"><img src="/resources/img/chevron-left.jpg"></a>
													</th>
										...
										<div class="under_wrap">
											...
											<div class="sr_wrap">
												...
												<p class="coredr_rg">
													예약선택일 <input type="text" class="reserDate_input" id="reserdate"
														name="rvReservdate" value=""> 일
												</p>
												<i></i>
												<p class="coredr_rg">
													예약선택시간 <input type="text" class="no02" id="resertime" name="rvTime"
														value="">시
												</p>
											</div>
										</div>
						...
						<div class="writeForm chg_writeForm">
							...
							<table>
								...
								<sec:authentication property="principal.mdto.mvo.userPhoneNum" var="userPhoneNum" />
								<tbody>
									<tr>
									...
									<tr>
										...
										<td><input data-value="비밀번호를 입력하세요." name="rvPw" id="password"
												class="inputPass wh420" type="password" maxlength="100"
												placeholder="영문과 숫자를 조합해 비밀번호를 입력해주세요">
										</td>
									</tr>
									<tr>
										<th><span class="col01">*</span>휴대폰</th>
										<td><input type="text" name="cell" id="cell" value="${userPhoneNum }"
												readonly="readonly"></td>
									</tr>
									<tr>
										<th><span class="col01">*</span>이메일</th>
										<td class="mail_type"><input data-value="이메일을 입력하세요." name="email1" id="email1"
												class="inputEmail wh420" type="text" value=${userEmail } maxlength="70"
												readonly="readonly">
										</td>
									</tr>
									<tr>
						...
						<div class="join chg_join">
							...
							<div class="joinTop">
								...
								<div class="jcheck">
									<input type="checkbox" data-value="개인정보취급방침에 동의하세요." id="agree02" name="agree02"
										value="" title="개인정보취급방침에 동의합니다 체크해주세요." class="hide"> <label for="agree02">
										<span></span>
										개인정보취급방침에 동의합니다.
									</label>
								</div>
						...
						<div class="writeForm_btn chg_writeForm_btn">
							<a href="write.php" class="cancel coredr_rg" style="font-size: 16px;">취소</a> <a
								href="javascript:;" id="w_btn" onclick="$('#frm').submit()" class="res coredr_md"
								style="background: #a77bca; font-size: 16px;">상담예약하기</a>
						</div>
						<input type="hidden" name="cmd" id="cmd" value="write"> <input type="hidden" name="email"
							id="email" value=""> <input type="hidden" name="curMonth" id="curMonth" value=""> <input
			...
			<div class="quick" style="top: 170px;">
				<div class="left">
					<ul>
						...
						<li><a href="javascript:;"> <img src="/resources/img/quick_reserve.png" class="off"><img
									src="/resources/img/quick_reserve.png" class="on"><br>
							</a></li>
						<li><a href="https://blog.naver.com/running8806" target="_blank">
								<!-- 210802 공식블로그 바로가기 추가 --> <img src="/resources/img/quick_blog.png" class="off"><img
									src="/resources/img/quick_blog.png" class="on"><br>
							</a></li>
						<li><a href="javascript:;"> <img src="/resources/img/quick_road.png" class="off"><img
				...
				<div class="right" style="width: 0px;">
					<div class="quick_cont">
						<div class="quick_box h30" id="quick_online_cont">
							...
							<form name="frmQProfessoional" id="frmQProfessoional" action="/process.php" method="post">
								<div class="q_box">
									<div class="q_name">
										<input type="text" class="name" name="name" data-value="이름을 입력해주세요."
											maxlength="50" title="이름" placeholder="이름">
									</div>
									<div class="q_phone">
										<input type="text" placeholder="핸드폰 번호" class="phone" name="cell"
											data-value="연락처를 입력해주세요." maxlength="13" onkeyup="isNumberOrHyphen(this);"
											onblur="cvtUserPhoneNumber(this);" value="" title="핸드폰 번호">
										<label for="p1"> <input type="checkbox" id="p1" name="iscall" value="1"> 수신
										</label>
									</div>
									<div class="q_email">
										<input type="text" placeholder="이메일" class="email" name="email"
											data-value="이메일을 입력해주세요." maxlength="100" value="" title="이메일">
										<label for="e1"> <input type="checkbox" id="e1" name="ismail" value="1"> 수신
										</label>
									</div>
									<div class="q_atten">
										<select name="clinic_fk" title="운동종목 선택" data-value="관심분야를 선택해 주십시오.">
									...
									<div class="q_content">
										<textarea placeholder="상담받으실 내용" name="contents" class="not_vali" title="내용"
											data-value="내용을 입력해주세요."></textarea>
									</div>
									...
									<div class="q_agree">
										<label for="agree1"> <input type="checkbox" id="agree1" name="agree"
												data-value="개인정보 수집에 동의해주세요."> 개인정보취급방침에
											동의합니다.
										</label>
									</div>
								</div>
								<input type="hidden" name="cmd" value="write"> <input type="hidden" name="setTablename"
									value="q_professional">
							</form>
							<div class="q_btn">
								<a>상담하기</a>
							</div>
						...
						<div class="quick_box">
							...
							<form name="frmQKakao" id="frmQKakao" action="/process.php" method="post">
								<div class="q_box">
									<div class="q_name">
									...
									<div class="q_phone">
										<input type="text" placeholder="핸드폰 번호" class="phone" name="cell"
											data-value="연락처를 입력해주세요." maxlength="13" onkeyup="isNumberOrHyphen(this);"
											onblur="cvtUserPhoneNumber(this);" value="" title="핸드폰 번호">
										<label for="p2"> <input type="checkbox" id="p2" name="iscall" value="1"> 수신
										</label>
									</div>
									<div class="q_atten">
										<select name="clinic_fk" title="진료과목 선택" data-value="진료과목을 선택해 주십시오.">
									...
									<div class="q_agree">
										<label for="agree2"> <input type="checkbox" id="agree2" name="agree2"
												data-value="개인정보 수집에 동의해주세요."> 개인정보취급방침에
											동의합니다.
										</label>
									</div>
							...
							<div class="q_btn">
								<a href="javascript:;" class="mt5" onclick="goSaveQuick(document.frmQKakao);">상담하기</a>
							</div>
						</div>
						<div class="quick_box h30" id="quick_cost_cont">
							...
							<form name="frmQCost" id="frmQCost" action="/process.php" method="post">
								<div class="q_box">
									<div class="q_name">
										<input type="text" placeholder="이름" class="name" name="name"
											data-value="이름을 입력해주세요." maxlength="50" value="" title="이름">
									...
									<div class="q_phone">
										<input type="text" placeholder="핸드폰 번호" class="phone" name="cell"
											data-value="연락처를 입력해주세요." maxlength="13" onkeyup="isNumberOrHyphen(this);"
											onblur="cvtUserPhoneNumber(this);" value="" title="핸드폰 번호">
										<label for="p3"> <input type="checkbox" id="p3" name="iscall" value="1"> 수신
										</label>
									</div>
									<div class="q_atten">
										<select name="clinic_fk" title="진료과목 선택" data-value="진료과목을 선택해 주십시오.">
									...
									<div class="q_agree">
										<label for="agree3"> <input type="checkbox" id="agree3" name="agree3"
												data-value="개인정보 수집에 동의해주세요."> 개인정보취급방침에
											동의합니다.
										</label>
									</div>
