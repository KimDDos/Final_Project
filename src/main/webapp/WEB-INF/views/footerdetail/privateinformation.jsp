...
② 득근득근은(는) 위탁계약 체결 시 개인정보 보호법 제25조에 따라
...
정보주체는 득근득근에 대해 언제든지 다음 각 호의 개인 정보 보호 관련 권리를 행사할 수 있습니다. 
① 개인정보 열람요구 ② 오류 등이 있을 경우 정정 요구 ③ 삭제요구 ④ 처리정지 요구에 대해
개인정보 보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 득근득근 은(는) 이에 대해 지체 없이 조치하겠습니다.
...
<strong>7. 처리하는 개인정보 항목 득근득근은(는) 다음의 개인정보 항목을 처리하고 있습니다.</strong> 
ο 수집항목 : 이름 , 생년월일, 로그인ID, 비밀번호, 휴대전화번호 , 이메일 주소, 접속로그, 쿠키, 서비스이용기록
ο 선택항목 : 지점, 관심분야, 이벤트선택항목, 가입경로, 메일링 및 SMS 서비스 수신여부 

<strong>8. 개인정보의 파기</strong>
① 득근득근은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
...
② 득근득근은(는) 다음의 방법으로 개인정보를 파기합니다. 
ο 전자적 파일 : 파일 삭제, 디스크 포맷, 기록을 재생할 수 없는 기술적 방법을 사용합니다.
ο 종이 문서 : 분쇄하거나 소각 

<strong>9. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</strong>
득근득근은(는) 이용자에게 특화된 맞춤서비스를 제공하기 위해서 이용자들의 정보를 수시로 저장하고 찾아내는 "쿠키(cookie)" 등을 운용합니다.
...
득근득근은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
ο 정기적인 자체 감사 실시
...
득근득근은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
